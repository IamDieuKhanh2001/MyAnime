                        ...
                        <div className="anime__details__content">
                            <div className="row">
                                <div className="col-lg-3">
                                    <div className="anime__details__pic set-bg" style={{ backgroundImage: "url('img/anime/details-pic.jpg')" }}>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-4">
                                <div className="anime__details__sidebar">
                                    ...
                                    <div className="product__sidebar__view__item set-bg" style={{ backgroundImage: "url('img/sidebar/tv-1.jpg')" }}>
                                        <div className="ep">18 / ?</div>
                                        <div className="view"><i className="fa fa-eye" /> 9141</div>
                                        <h5><a href="#">Boruto: Naruto next generations</a></h5>
                                    </div>
                                    <div className="product__sidebar__view__item set-bg" style={{ backgroundImage: "url('img/sidebar/tv-2.jpg')" }}>
                                        <div className="ep">18 / ?</div>
                                        <div className="view"><i className="fa fa-eye" /> 9141</div>
                                        <h5><a href="#">The Seven Deadly Sins: Wrath of the Gods</a></h5>
                                    </div>
                                    <div className="product__sidebar__view__item set-bg" style={{ backgroundImage: "url('img/sidebar/tv-3.jpg')" }}>
                                        <div className="ep">18 / ?</div>
                                        <div className="view"><i className="fa fa-eye" /> 9141</div>
                                        <h5><a href="#">Sword art online alicization war of underworld</a></h5>
                                    </div>
                                    <div className="product__sidebar__view__item set-bg" style={{ backgroundImage: "url('img/sidebar/tv-4.jpg')" }}>
                                        <div className="ep">18 / ?</div>
                                        <div className="view"><i className="fa fa-eye" /> 9141</div>
