                            ...
                            <div className="row">
                                <div className="col-lg-3">
                                    <div className="anime__details__pic set-bg"
                                         style={{backgroundImage: "url('img/anime/details-pic.jpg')"}}>
                                ...
                                <div className="col-lg-9">
                                    <div className="anime__details__text">
                                        ...
                                        <p className="anime__details__description">Every human inhabiting the world of
                                            Alcia is branded by a “Count” or a number written on
                                            their body. For Hina’s mother, her total drops to 0 and she’s pulled into
                                            the Abyss,
                                            never to be seen again. But her mother’s last words send Hina on a quest to
                                            find a
