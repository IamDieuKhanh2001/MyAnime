...
import { APIAddMovie, APIGetMovieCategories, APIUpdateMovie } from "../../../../../api/axios/adminAPI";
...
export default function UpdateMovie({ movie, hideDiaglogUpdate }) {
    ...
    const isShowModalUpdateMovie = useSelector(state => state.admin.isShowModalUpdateMovie)
    let isInvalidUpdateMovie = useSelector(state=>state.admin.isInvalidUpdateMovie)
                            ...
                            <div className="updateMovieForm">
                                ...
                                <div className="card-body">
                                    <div className="addForm">
                                        ...
                                        <button disabled={isInvalidUpdateMovie} className="btn btn-danger px-4" type="submit">
                                            {isSubmitting && (
