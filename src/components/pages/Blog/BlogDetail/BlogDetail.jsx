              ...
              <div className="blog__details__content">
                ...
                <div className="blog__details__item__text">
                  ...
                  <p>
                    ...
                    him isolated in the first place.&nbsp; It’s better for the
                    Crows to sort this out in practice matches than the real
                    deal, but this is really on Tobio – he has to figure out how
                    to co-exist with others in a team environment.
                  </p>
                </div>
                <div className="blog__details__item__text">
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="blog__details__btns__item">
                        <h5>
                          <a href="#">
                            <span className="arrow_left" /> Building a Better
                            LiA...
                          </a>
                        </h5>
                      </div>
